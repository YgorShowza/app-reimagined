...
-- Tentativas de prova: usuário comum só acessa/insere se estiver ativo.
...
-- Atividades rápidas: leitura própria apenas enquanto ativo.
...
-- Ocorrências: criação e leitura própria exigem vínculo ativo.
...
-- Assinatura: além de pertencer ao usuário, a conta precisa estar ativa.
...
-- Storage de assinaturas: conta inativa não lê/escreve o próprio diretório.
