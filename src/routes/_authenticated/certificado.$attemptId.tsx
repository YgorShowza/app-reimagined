...
function CertificateAdminPage() {
  ...
  return <div className="certificate-screen mx-auto max-w-[1180px] space-y-4 pb-10">
    <div className="sticky top-0 z-20 flex flex-wrap items-center justify-between gap-3 rounded-2xl p-3" style={{ background: "var(--bg-surface)", border: "1px solid var(--border)", boxShadow: "var(--shadow-card, var(--shadow-md))" }}>
      ...
      <div className="text-center"><p className="text-sm font-black" style={{ color: "var(--text-1)" }}>Certificado de Aptidão</p><p className="text-xs" style={{ color: "var(--text-4)" }}>Visualização institucional vinculada à avaliação</p></div>
      <div className="rounded-xl px-3 py-2 text-xs font-bold" style={{ background: "rgba(245,158,11,.10)", color: "#b7791f", border: "1px solid rgba(245,158,11,.25)" }}>Exportação PDF em ajuste</div>
    </div>
