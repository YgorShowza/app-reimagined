...
import { CalendarDays, CheckCircle2, Loader2, Search, Sparkles, Users } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-2xl max-h-[92vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="space-y-1.5"><Label>Tema da avaliação *</Label><Input list="cronograma-evaluation-themes" value={theme} onChange={(event) => setTheme(event.target.value)} placeholder="Ex.: Procedimento de acesso" /><datalist id="cronograma-evaluation-themes">{themeOptions.map((option) => <option key={option} value={option} />)}</datalist></div>
